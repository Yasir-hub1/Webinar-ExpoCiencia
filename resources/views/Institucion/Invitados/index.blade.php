...
<div class="page-title-box" style="padding: 15px">
    <div class="container-fluid">
        <div class="page-title dflex-between-center">
            <h3 class="mb-1 font-weight-bold" style="font-size:50px ">Lista De Invitados</h3>
                        ...
                        @foreach ($invitado as $invitados)
                            <tr>
                                ...
                                <td>
                                            ...
                                            <img class="text-gray-600 text-hover-primary mb-1" src="{{asset('image/participantes/invitados/'.$invitados->foto)}}"  width="60" height="70"/>
                                </td>
                                ...
                                <td>{{ $invitados->Profesion->nombre }}</td>
                                {{-- <td>{{ $invitados->biografia }}</td> --}}
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('edit.Invitado', $invitados->id) }}"
                                                class="menu-link px-3">Editar</a>
                                        </div>
                                        <form action="{{ route('delete.Invitado', $invitados->id) }}"
                                            method="post">
                                            @csrf
                                            @method('DELETE')
                                            <div class="menu-item px-3">
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    ...
                    <form name="enviarFormulario" class="form"
                        action="{{ route('store.Invitado') }}" method="POST"
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            ...
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll"
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" class="form-control form-control-solid"
                                        placeholder="correo" name="correo" value="" />
                                    <!--end::Input-->
                                ...
                                <div id="kt_modal_add_customer_billing_info" class="collapse show">
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <input type="file" class="form-control form-control-solid" placeholder="Facultad"
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <select name="profesion_id" aria-label="Select a Country"
